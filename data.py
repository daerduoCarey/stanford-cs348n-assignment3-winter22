"""
    PartNet structured shape data loader
"""
...
class Tree(object):
    ...
    class Node(object):
        ...
        def __init__(self, part_id=0, is_leaf=False, box=None, label=None, children=None, full_label=None):
        ...
        def _to_str(self, level, pid, detailed=False):
            ...
            # call the _to_str function for each child
